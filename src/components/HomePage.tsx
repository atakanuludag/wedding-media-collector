...
export function HomePage() {
  ...
  return (
    <div className="relative min-h-full overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-full max-w-lg flex-col px-4 py-8 sm:max-w-xl sm:px-6 sm:py-12">
        ...
        <section className="mb-10">
          <UploadZone
            onUploadComplete={() => setGalleryRefresh((current) => current + 1)}
          />
        </section>
        ...
        <footer className="mt-12 pb-4 text-center text-xs text-stone-400">
